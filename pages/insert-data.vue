...
const { error, refresh: refreshBuildings } = await useFetch(
...
<template>
  <div class="flex">
    ...
    <form class="mx-auto max-w-[700px] flex-1" @submit.prevent>
      <h2 class="font-semibold text-2xl mb-8">YSC Kayit formu</h2>
      <div class="space-y-6 mt-6 w-full">
        ...
        <div class="form-row">
          ...
          <div class="form-item">
            ...
            <InputText id="location_id" v-model="form.location.location_id" />
          </div>
        </div>
        <div class="form-row">
          <div class="form-item">
        ...
        <div class="form-row">
          <div class="form-item">
            ...
            <InputText id="brand" v-model="form.product.brand" />
          </div>
          <div class="form-item">
    ...
    >
      ...
      <span class="text-surface-500 dark:text-surface-400 block mb-8">
        Bina oluşturduktan sonra o binaya bağlı olarak tam konumu
        belirleyebilirsin.
      </span>
      <div class="form-item mb-12">
        <label for="building-name">Bina adi</label>
        <InputText id="building-name" v-model="newBuilding.name" />
      </div>
      <div class="flex justify-end gap-2">
        ...
        />
        <Button type="button" label="Kaydet" @click="saveNewBuilding" />
      </div>
    </Dialog>
  </div>
</template>
